...
Route::group(["middleware" => ["auth:api", CheckAccountStatus::class]], function () {
    ...
    Route::get('/admin/reports/earnings', [ReportsController::class, 'getEarnings']);
    ...
    Route::get('/artist/reports/earnings', [ReportsController::class, 'getMyEarnings']);
    ...
    Route::get('/sales/{id}/cancellation-preview', [PaymentController::class, 'cancellationPreview']);
    Route::get('/client/sales/{id}/receipt', [PaymentController::class, 'downloadReceipt']);

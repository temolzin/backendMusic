...
class UserSanctionSeeder extends Seeder
{
    public function run()
    {
        $targetEmails = ['yatziry@gmail.com', 'carlosramirez@gmail.com', 'valeriatorres@gmail.com'];
        
        $users = User::whereIn('email', $targetEmails)->get()->values();
        ...
        foreach ($users as $index => $user) {
            ...
            } elseif ($pattern['source'] === 'expired_approval') {

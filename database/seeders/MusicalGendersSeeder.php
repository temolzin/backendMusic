...
class MusicalGendersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $gender->addMediaFromUrl('https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=300&h=300&fit=crop')->toMediaCollection('musical_gender_image');
        ...
        $gender->addMediaFromUrl('https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=300&h=300&fit=crop')->toMediaCollection('musical_gender_image');
        ...
        $gender->addMediaFromUrl('https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=300&h=300&fit=crop')->toMediaCollection('musical_gender_image');
        ...
        $gender->addMediaFromUrl('https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=300&h=300&fit=crop')->toMediaCollection('musical_gender_image');
        ...
        $gender->addMediaFromUrl('https://images.unsplash.com/photo-1461784121038-f088ca1e7714?w=300&h=300&fit=crop')->toMediaCollection('musical_gender_image');
        ...
        $gender->addMediaFromUrl('https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=300&h=300&fit=crop')->toMediaCollection('musical_gender_image');
        ...
        $gender->addMediaFromUrl('https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=300&h=300&fit=crop')->toMediaCollection('musical_gender_image');
    }
}
